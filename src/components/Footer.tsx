        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-background/70 mb-6 max-w-sm">
              cashadvancenetwork.com online loan platform offers installment loans to middle-income consumers, who may have bad credit or no credit and require personal loans, loans for bad credit, or no credit check loans.
            </p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex items-center">
            <div>
              ...
              <p className="text-background/70">support@cashadvancenetwork.com</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-background/10">
        <div className="container mx-auto px-4 py-6">
          <div className="text-xs text-background/50 leading-relaxed space-y-4">
            <p>
              Cash Advance Network Online ("Cash Advance Network Online" or "we" or "our") owns and operates the website located at cashadvancenetwork.com (the "Site"). Cash Advance Network Online provides and maintains this site for your information, conditioned on your acceptance, without modification, of the terms, conditions and notices contained in this Terms of Use.
            </p>
            <p>
