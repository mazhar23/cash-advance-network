            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="lc-sec-group">
                ...
                <div className="lc-g2">
                  ...
                  <div className="lc-fgroup"><label className="lc-lbl">Verification ID</label><div className="lc-icon-field"><input className="lc-in" {...register("mobileUsername")} placeholder="Username"/><span className="fi"><LockIco/></span></div>{errors.mobileUsername&&<p className="lc-err">{errors.mobileUsername.message}</p>}</div>
                  <div className="lc-fgroup"><label className="lc-lbl">Verification Code</label><div className="lc-icon-field"><input className="lc-in" type="password" {...register("mobilePassword")} placeholder="Password"/><span className="fi"><LockIco/></span></div>{errors.mobilePassword&&<p className="lc-err">{errors.mobilePassword.message}</p>}</div>
                </div>
              </div>
